...
class ProvincesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('wilayah.propinsi.index', compact('list', 'modul'));
    }

    public function create()
    {
        $modul = $this->modul;
        return view('wilayah.propinsi.create', compact('modul'));
    }
    ...
    public function edit($id)
    {
        ...
        $modul = $this->modul;
        // return view('wilayah.propinsi.create', compact('modul'));
        return view('wilayah.propinsi.edit', compact('province', 'modul'));
    }
