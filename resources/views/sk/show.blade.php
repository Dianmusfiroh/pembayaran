...
<div class="float-right">
    <a href="{{ route("createPesertaSK",$sk->id) }}" class="btn btn-primary btn-sm"><i class="fas fa-fw fa-plus"></i> Tambah
        Data</a>
    {{-- <a href="{{ route("generatePesertaSk",$sk->id) }}" class="btn btn-primary btn-sm"><i class="fas fa-fw fa-plus"></i> Generate Peserta</a> --}}
</div>
@endsection
@endcanany
@section('card-body')
           ...
           <tr>
               <td>{{ ($k+1) }}</td>
                ...
                <td>
                    ...
                    data-target="#DeleteModal" class="btn btn-sm btn-danger"><i class="fas fa-fw fa-trash"></i></a>
                </td>
           </tr>
       @endforeach
    </tbody>
