...
@section('form-create')
<form action="{{ route($modul.'.update', $kinerja->id)}}" method="POST">
    @csrf
    @method('PUT')
    ...
    <div class="form-group row">
        ...
        <div class="col-md-9">
            {{-- <select name="gtt_id" id="peserta" class="form-control" value='{$kinerja->gtt_id}}'> --}}
                <input type="text" name="nik" id="nik" class="form-control " value="{{$kinerja->gtt->full_name}}" readonly>
    ...
    <div class="form-group row">
        ...
        <div class="col-md-9">
            <input type="text" name="presentase" id="presentase" class="form-control" placeholder="Masukan kinerja" required value="{{$kinerja->presentase}}">
        </div>
    </div>
