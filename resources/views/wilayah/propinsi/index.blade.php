...
<div class="float-right">
    <a href="{{ url('master/wilayah/provinsi/create') }}" class="btn btn-primary btn-sm"><i
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="text-center">
                @foreach ($item->kabupatens as $kab)
                <li style="list-style: none">{{ $kab->name }}</li>

                @endforeach
            </td>
            <td>
                <a href="{{ url('master/wilayah/provinsi/' . $item->id . '/edit') }}" class="btn btn-success btn-sm"
